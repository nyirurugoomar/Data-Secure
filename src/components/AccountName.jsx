        ...
        <div className="account-page">
            ...
            <Bounce bottom>
                <h3 className="xl:text-5xl md:text-4xl text-2xl font-semibold leading-tight text-center text-gray-800 sm:mb-0 mb-12">
                    More Than 10 Years We Provide Secure Service <br className="md:block hidden" />
                    in Real State Industry All Over The World.
                </h3>
            </Bounce>   
                <div className="md:mt-14 mt-4 relative sm:flex items-center justify-center">
                    ...
                    <div className="shadow-lg xl:p-6 p-4 sm:w-auto w-full bg-white sm:absolute relative z-20 sm:mt-0 mt-4 left-0 xl:ml-56 sm:ml-12 xl:-mt-40 sm:-mt-12">
                        <p className="text-3xl font-semibold text-blue-900">20K+</p>
                        <p className="text-base leading-4 xl:mt-4 mt-2 text-blue-900">Recently Property Listed</p>
                    </div>
                    <div className="shadow-lg xl:p-6 p-4 w-48 sm:w-auto w-full bg-white sm:absolute relative z-20 sm:mt-0 mt-4 xl:mt-80 sm:mt-56 xl:-ml-0 sm:-ml-12">
                        <p className="text-3xl font-semibold text-blue-900">8K+</p>
                        <p className="text-base leading-4 xl:mt-4 mt-2 text-blue-900">Active Listening</p>
                    </div>
                    <div className="shadow-lg xl:p-6 p-4 sm:w-auto w-full bg-white sm:absolute relative z-20 md:mt-0 sm:-mt-5 mt-4 right-0 xl:mr-56 sm:mr-24">
                        <p className="text-3xl font-semibold text-blue-900">15K+</p>
                        <p className="text-base leading-4 xl:mt-4 mt-2 text-blue-900">Recently Sold Lands</p>
                    </div>
                </div>
            </div>
        </div>
